...
This folder contains supporting project-history and troubleshooting
documentation that is too detailed for the recruiter-focused root
README.
...
The root README presents the project overview, key results, major
evidence and current status.

The development journal preserves the chronological Day 1 through Day 6
history.
